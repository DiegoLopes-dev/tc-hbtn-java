...
public class Celular {
    ...
    private ArrayList<Contato> contatosBuscados = new ArrayList<Contato>();
    ...
    public void adicionarContato(Contato contato) {
        for (Contato adicionarContato : contatos) {
            if(adicionarContato.getNome().equals(contato.getNome())){
